...
\usepackage{caption,subcaption,graphicx,longtable,underscore,moreverb,booktabs}
%\usepackage{multicol}
...
\begin{table*}[h]
    ...
    \resizebox{\textwidth}{!}{% <--- Start the resizebox command
        \begin{tabular}{@{}l c c c c c c c@{}}
            \toprule
            \textbf{Configuration} & \textbf{Shocks} & \textbf{Lag depth} & \textbf{Lagged shocks} & \textbf{RMSE} & \textbf{MAE} & $\mathbf{R^2}$ & \textbf{Balanced accuracy} \\ 
            \midrule
            Persistence baseline & \multicolumn{1}{c}{---} & \multicolumn{1}{c}{---} & \multicolumn{1}{c}{---} & 0.0699 & 0.0554 & 0.6443 & \\
            (FSI(t)=FSI(t-1)) & & & & & & & \\
            \addlinespace
...
%     \end{subfigure}
    \centering
    \includegraphics[width=1\linewidth]{fig6_roc_bootstrap10.png}
...
%     \end{subfigure}
    \centering
    \includegraphics[width=1\linewidth]{fig1_confusion_matrix.png}
    \caption{Confusion matrix $\Delta FSI$ > 0}
    \label{fig:8}
\end{figure*}
