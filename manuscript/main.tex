...
\begin{figure*}
    ...
    \caption{Confustion Matrix}
    \label{fig:2}
\end{figure*}

\begin{figure*}
   \centering
   \includegraphics[width=1\linewidth]{fig2_timeseries_actual_pred_persist.png}
   \caption{Comparision of different prediction methods}
   \label{fig:3}
\end{figure*}
    % \begin{figure*}
    %     \centering
...
%         \label{fig:4d}
%         \end{subfigure}
    \caption{Scatter plots between Actual and Predicted data for 2013-2023}
    \label{fig:4}
\end{figure}
...
\begin{figure}
    ...
    \caption{Residual plot over time period 2013-2023}
    \label{fig:5}
\end{figure}
...
%     \end{subfigure}
    \centering
    \includegraphics[width=1\linewidth]{fig5_residual_hist.png}
    fig6_roc_bootstrap10
    \caption{Histogram of Residual Errors}
    \label{fig:6}
\end{figure}
...
%     \end{subfigure}
    ...
    \caption{ROC curve for 2022 Training model}
    \label{fig:7}
\end{figure}
