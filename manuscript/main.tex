...
\newcommand{\WordCount}{\large \textit{\\Word count (excluding figures, tables, references, and title page):} 
4455}
...
\end{abstract}  
{\textbf{Keywords}: \\ Agriculture, Food Security Index, ............}
...
The team would like to thank the support from Dr. Jianshan Chen in University of Alberta. We would also like to thank STEM Fellowship for providing us the opportunity to participate in the HSBDC. 
