...
\affil[1]{School 1, City, Province}
\affil[2]{School 2}
...
Also, please do remember that the STEM Fellowship Journal is an open-access journal, which means that the full final papers of previous projects are a simple Google search away!
...
%% The bibliography automatically generates using the .bib file that is on the left! Be sure to use the correct citation style (Vancouver) and ensure that your sources are all trustworthy and reputable.
