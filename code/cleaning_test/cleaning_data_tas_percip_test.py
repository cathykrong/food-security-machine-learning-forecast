...
INPUT_XLSX = "E:/1Cathy/hsbdc 202526/data/precip_1901_2023.xlsx"     # <-- change if needed
SHEET_NAME = 0                        # 0 = first sheet, or put the sheet name string
OUT_CSV = "E:/1Cathy/hsbdc 202526/data/cleaned_test/precip_mm_cleaned.csv"
...
if __name__ == "__main__":
    out = clean_climate_wide_to_long(
        ...
        value_col_name="precip_mm",      # change to "precip_mm" for precipitation file
